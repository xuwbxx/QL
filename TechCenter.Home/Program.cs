...
builder.Services.AddScoped<DataLoginService>();
builder.Services.AddScoped<SSOService>();
builder.Services.AddScoped<TC_DepartService>();
builder.Services.AddScoped<TC_SoftwareService>();
builder.Services.AddScoped<TC_MonitorService>();
