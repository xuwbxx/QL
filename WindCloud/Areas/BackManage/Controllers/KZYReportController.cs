...
{
    [Area("BackManage")]
    public class KZYReportController : WebEncryptionController
    {
        private readonly BackKZYReportService _backKZYReportService;

        public KZYReportController(CookieService cookieService, Service.Wind.WebValidateService webValidateService, BackKZYReportService backKZYReportService)
            : base(cookieService, webValidateService)
        {
            _backKZYReportService = backKZYReportService;
        }
        ...
        public IActionResult ListQuery(CloudWindBackManageRequest request)
        {
            ...
            try
            {
                var (list, totalCount, pageIndex, msg) = _backKZYReportService.ListQuery(request);
            ...
            {
                ret.Success = false;
                LoggerUtils.Error(ex.ToString(), typeof(KZYReportController));
            }
        ...
        public IActionResult DataQuery(CloudWindBackManageRequest request)
        {
            ...
            try
            {
                var (data, msg) = _backKZYReportService.DataQuery(request);
        ...
        public IActionResult DataSave(CloudWindBackManageRequest request)
        {
            ...
            try
            {
                string result = _backKZYReportService.DataSave(request);
